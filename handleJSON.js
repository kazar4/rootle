...
function getBizSearch(address, biz){
    URL = 'http://127.0.0.1:5000/getFromBusiness/?loc=' + address + "&bbs=" + biz;
...
function getCustomSearch(address, query){
    URL = 'http://127.0.0.1:5000/getFull/?loc=' + address + "&inp=" + query;
    JSON.parse(httpGet(URL));
}

//gets more details from a specific location
function getSpecficLocation(Location_ID){
    URL = 'http://127.0.0.1:5000/getBusiness/' + Location_ID;
    JSON.parse(httpGet(URL));
}
...
function getData(){
    ...
    if (!toggle_button) {
        URL = 'http://127.0.0.1:5000/getFromBusiness/?loc=' + address + "&bbs=" + business_category;
    ...
    //General Search
        ...
        URL = 'http://127.0.0.1:5000/getFromBusiness/?loc=' + address + "&inp=" + business_category;
